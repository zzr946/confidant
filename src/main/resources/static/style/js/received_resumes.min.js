...
$(function () {
    $("#filter_btn").bind("click", function () {
        ...
        submitHandler: function (a) {
            var b = $('textarea[name="content"]', a).val(), c = $('input[name="deliverId"]', a).val(),
                d = $("#resubmitToken").val();
            $.ajax({
        ...
        submitHandler: function (a) {
            var b = $('input[name="recipients"]', a).val(), c = $('input[name="title"]', a).val(),
                d = $('textarea[name="content"]', a).val(), e = $('input[name="resumeKey"]', a).val(),
                f = $('input[name="deliverId"]', a).val(), g = $('input[name="positionId"]', a).val(),
                h = $("#resubmitToken").val();
            $.ajax({
                type: "POST",
        ...
        var a = $(this).attr("data-email"), b = $(this).attr("data-positionId"), c = $(this).attr("data-name"),
        ...
        submitHandler: function (a) {
            var b = $('input[name="name"]', a).val(), c = $('input[name="email"]', a).val(),
                d = $('input[name="subject"]', a).val(), e = $('input[name="interTime"]', a).val(),
                f = $('input[name="interAdd"]', a).val(), g = $('input[name="linkMan"]', a).val(),
                h = $('input[name="linkPhone"]', a).val(), i = $('textarea[name="content"]', a).val(),
                j = $('input[name="positionName"]', a).val(), k = $('input[name="companyName"]', a).val(),
                l = $('input[name="deliverId"]', a).val(), m = $("#resubmitToken").val();
            $.ajax({
                type: "POST",
                data: {
                    name: b,
