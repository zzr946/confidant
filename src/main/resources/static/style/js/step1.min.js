...
$("#hidden_submit").click(function () {
    ...
    if(companyName==""||companyName==null){
        layer.alert("请输入公司名称！",{icon:2});
        return false;
    }

    if(companyLogo=="style/images/upload.png"){
        layer.alert("请上传公司logo！",{icon:2});
        return false;
    }

    if(companyUrl==""||companyUrl==null){
        layer.alert("请输入公司网址！",{icon:2});
        return false;
    }
    if(!isURL(companyUrl)){
    ...
    if(companyCity==""||companyCity==null){
        layer.alert("请输入公司所在城市！",{icon:2});
        return false;
    }
    if(companyField==""||companyField==null){
        layer.alert("请输入公司所属的行业领域！",{icon:2});
        return false;
    }
    if(companyScale==""||companyScale==null){
        layer.alert("请输入公司规模！",{icon:2});
        return false;
    }
    if(companyStage==""||companyStage==null){
        layer.alert("请输入公司发展阶段！",{icon:2});
        return false;
    }
    if(reserved2==""||reserved2==null){
        layer.alert("请输入公司愿景！",{icon:2});
        return false;
    }
    if(reserved2.length>50){
        layer.alert("公司愿景字数限制在50字以内！",{icon:2});
        return false;
    }
    ...
    //数据校验通过，则向后台发送请求
    //layer.alert("向后台发送请求，存入公司基本信息！",{icon:1});
    $("#stepBtn").click();
})
