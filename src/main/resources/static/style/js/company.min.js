...
function product_check(a, b, c, d, e, f) {
...
function member_check(a, b, c, d, e, f) {
...
$(function () {
    ...
    $(".tipExpire .expire_close").bind("click", function () {
        ...
        $("#hasLabels li").each(function () {
            ...
            type: "POST",
            data: {companyId: d, labels: b.join()},
        ...
        $("#Member .member_wrap").length >= 3 && $("#Member .c_add").hide(), $(".memberForm", a).validate({
            ...
            rules: {
                ...
                name: {required: !1},
                position: {required: !1},
                weibo: {required: !1, checkUrlNot: !0, maxlength: 80},
                remark: {required: !1, minlength: 10, maxlength: 500}
            },
            messages: {
                weibo: {checkUrlNot: "请输入真实的新浪微博地址", maxlength: "请输入80字符以内的网址"},
                remark: {minlength: "请输入10-500字的个人简介", maxlength: "请输入10-500字的个人简介"}
            },
            submitHandler: function (b) {
                var i, j, c = $("#companyId").val(), d = $(".leader_id", b).val(), e = $(".leaderInfos", b).val(),
                ...
                "" != h && "http://" != h.substring(0, 7) && (h = "http://" + h), i = "请输入创始人个人简介" != $('textarea[name="remark"]', b).val() ? $('textarea[name="remark"]', b).val() : "", j = $("#resubmitToken").val(), a = $(b).parents(".member_wrap"), $(b).find(":submit").attr("disabled", !0), $.ajax({
                    ...
                    data: {companyId: c, id: d, photo: e, name: f, position: g, weibo: h, remark: i, resubmitToken: j},
                    dataType: "json"
                }).success(function (c) {
        ...
        var a = $(this), b = $.trim(a.val()).length;
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                var h, i, j, b = $("#companyId").val(), c = $(".leader_id", a).val(), d = $(".leaderInfos", a).val(),
                ...
                "" != g && "http://" != g.substring(0, 7) && (g = "http://" + g), h = "请输入创始人个人简介" != $('textarea[name="remark"]', a).val() ? $('textarea[name="remark"]', a).val() : "", i = $(a).parents(".member_wrap"), j = $("#resubmitToken").val(), $(a).find(":submit").attr("disabled", !0), $.ajax({
                    type: "POST",
                    url: ctx + "/cl/saveLeaderInfo.json",
                    data: {companyId: b, id: c, photo: d, name: e, position: f, weibo: g, remark: h, resubmitToken: j},
                    dataType: "json"
                }).success(function (b) {
        ...
        $("#Product .product_wrap").length >= 3 && $(".product_add").addClass("dn"), $(".productForm", a).validate({
            ...
            rules: {
                myfiles: {required: !1},
                product: {required: !1, maxlength: 20},
                productUrl: {required: !1, checkUrlNot: !0, maxlength: 80},
                productProfile: {required: !1, minlength: 10, maxlength: 500}
            },
            messages: {
                product: {maxlength: "请输入20字符以内的产品名称"},
                productUrl: {checkUrlNot: "请输入有效的产品主页或产品下载地址", maxlength: "请输入80字符以内的网址"},
                productProfile: {minlength: "请输入10-500字的产品简介", maxlength: "请输入10-500字的产品简介"}
            },
            submitHandler: function (b) {
                var h, i, c = $("#companyId").val(), d = $(".product_id", b).val(), e = $(".productInfos", b).val(),
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                var g, h, i, b = $("#companyId").val(), c = $(".product_id", a).val(), d = $(".productInfos", a).val(),
        ...
        onkeyup: !1,
        rules: {companyShortName: {required: !1}, companyFeatures: {required: !0, minlength: 5, maxlength: 50}},
        messages: {
            companyFeatures: {
        ...
        submitHandler: function (a) {
            ...
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                ...
                data: {companyId: b, companyShortName: d, companyFeatures: c},
                dataType: "json"
            }).success(function (b) {
        ...
        onfocusout: !1,
        onsubmit: !0,
        rules: {companyProfile: {required: !1, rangeLen: [20, 1e3]}},
        messages: {companyProfile: {rangeLen: "请输入20-1000字的公司介绍"}},
        submitHandler: function (a) {
            var b = $("#companyId").val(),
            ...
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                ...
                data: {companyId: b, companyProfile: c},
                dataType: "json"
            }).success(function (b) {
                if (b.success) if ("" == b.content) $("dl:nth-child(1)", d).show(), $("dl:nth-child(2) textarea", d).val(""), $("dl:nth-child(2)", d).hide(), $("dl:nth-child(3) .c_intro", d).html(""), $("dl:nth-child(3)", d).hide(); else {
        ...
        focusCleanup: !0,
        rules: {
            city: {required: !0, checkCity: !0},
            industryField: {required: !0},
            companySize: {required: !0},
            companyUrl: {required: !0, checkUrl: !0, maxlength: 80}
        },
        messages: {
            city: {required: "请输入公司所在城市，如：北京"},
            industryField: {required: "请选择公司行业领域"},
            companySize: {required: "请选择公司规模"},
            companyUrl: {required: "请输入公司网址，如：www.lagou.com", checkUrl: "请输入有效的公司网址", maxlength: "请输入80字符以内的网址"}
        },
        errorPlacement: function (a, b) {
            "hidden" == b.attr("type") ? a.insertAfter($(b).parent()) : a.insertAfter(b)
        },
        submitHandler: function (a) {
            var b = $("#companyId").val(), c = $("#city", a).val(), d = $("#industryField", a).val(),
                e = $("#companySize", a).val(), f = $("#companyUrl", a).val();
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                type: "POST",
                url: ctx + "/cd/saveProfileBaseInfo.json",
                data: {companyId: b, city: c, industryField: d, companySize: e, companyUrl: f},
                dataType: "json"
            }).success(function (b) {
        ...
        var e, f, a = $(this).parents("#tagForms"), b = $("#comCity", a).val(), c = $("#comInd", a).val();
        ...
        onkeyup: !1,
        focusCleanup: !0,
        rules: {stageorg: {required: !1, maxlength: 200}},
        messages: {stageorg: {maxlength: "请输入200字以内的投资机构"}},
        submitHandler: function (a) {
            var d, e, f, b = $("#financeStage").val(), c = "";
            c += "[", $("#stagesList > li").each(function (a) {
                ...
                type: "POST",
                data: {financeStage: b, stages: c, resubmitToken: f},
        ...
        obj: $("#Reported"), addReport: function () {
            var a = this.obj.find(".newReport").children("li").clone();
            this.obj.find("ul.reset").append(a).removeClass("dn"), $(".reportForm", a).validate({
                onkeyup: !1,
                focusCleanup: !0,
                rules: {
                    articleTitle: {required: !0, specialchar: !0, checkNum: !0},
                    articleUrl: {required: !0, checkUrl: !0}
                },
                messages: {
                    articleTitle: {required: "请输入文章标题", specialchar: "请输入有效的文章标题", checkNum: "请输入有效的文章标题"},
                    articleUrl: {required: "请输入文章链接", checkUrl: "请输入有效的文章链接"}
                },
                submitHandler: function (a) {
                    var b = $('input[name="articleTitle"]', a).val() != $('input[name="articleTitle"]', a).attr("placeholder") ? $('input[name="articleTitle"]', a).val() : "",
                        ...
                        d = $(".article_id", a).val(), e = $("#companyId").val(), f = $("#resubmitToken").val();
                    $(a).find(":submit").attr("disabled", !0), $.ajax({
                        url: ctx + "/article/save.json",
                        type: "POST",
                        data: {title: b, url: c, id: d, companyId: e, resubmitToken: f},
                        dataType: "json"
                    }).done(function (b) {
                        var c, d, e;
            ...
            var b = a.siblings("a.article").attr("title"), c = a.siblings("a.article").attr("href");
            ...
            var b = this.obj, c = a.siblings(".article_id").val();
            $.ajax({url: ctx + "/article/del.json", type: "POST", data: {id: c}}).done(function (c) {
